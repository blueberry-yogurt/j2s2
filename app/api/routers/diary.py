...
from app.schemas.diary import DiaryCreate, DiaryResponse, DiaryUpdate # schemas는 별도 정의 필요
...
async def update_diary(
    ...
    return await DiaryRepository.update(diary, **diary_in.dict())
...
async def delete_diary(
    ...
    if not diary or diary.user_id != current_user.id:
        raise HTTPException(status_code=404, detail="일기를 찾을 수 없거나 권한이 없습니다.")
